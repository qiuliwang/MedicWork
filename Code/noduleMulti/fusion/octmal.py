...
if __name__ =='__main__':        
    ...
    keep_prob = 1
    epoch = 40
    learning_rate = tf.train.exponential_decay(0.005, global_step * batch_size, 64*40*81, 0.9, staircase=True)

    # path = '/data0/LUNA/cubic_normalization_npy'
    path = '/home/wangqiuli/Documents/sept_mail/train/'
