...
basedir = '/raid/data/wangqiuli/Documents/noduleMulti/august_mali/train/'
...
def get_train_and_test_filenamex(path,test_size,seed):
...
# def get_train_and_test_filenames(path):
#     filelist = os.listdir(path)
#     return filelist
