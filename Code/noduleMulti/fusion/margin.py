...
class modelmargin(object):
    ...
    def __init__(self,learning_rate,keep_prob,batch_size,epoch):
        ...
        self.saver = tf.train.import_meta_graph('/home/wangqiuli/raid/noduleMulti/dec_marge/fully_ckpt/fully-80.meta')  # default to save all variable,save mode or restore from path

        # self.sess.run(tf.global_variables_initializer())
        self.saver.restore(self.sess, tf.train.latest_checkpoint('/home/wangqiuli/raid/noduleMulti/dec_marge/fully_ckpt/'))
