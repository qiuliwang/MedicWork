...
from dataprepare import get_batch,get_train_and_test_filenames, get_batch_withlabels, get_high_data, get_batch_withlabels_high
...
if __name__ == '__main__':
    ...
    train_filenames,test_filenames = get_train_and_test_filenames(path, 0.999, 121)
    ...
    for i in range(2):
        ...
        for t in range(2):
            ...
            highfiles = []
            lowfiles = []
            for nodules in test_filenames:
                if 'high' in nodules:
                    highfiles.append(nodules)
                elif 'low' in nodules:
                    lowfiles.append(nodules)
