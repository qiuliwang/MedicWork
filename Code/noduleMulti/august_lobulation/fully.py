    ...
    def inference(self,npy_path,model_index,test_size,seed,train_flag=True):
        ...
        if train_flag:
            ...
            with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
                ...
                # how many time should one epoch should loop to feed all data
                    ...
                    for i in range(self.epoch):
                        ...
                        test_dict = {x: test_batch,sphericity: sphericityt, margin: margint, lobulation: lobulationt, spiculation: spiculationt, real_label: test_label, keep_prob:1}
            ...
            with tf.Session() as sess:
                ...
                saver = tf.train.import_meta_graph('./fully_ckpt/fully-10.meta')
