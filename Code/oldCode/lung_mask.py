...
if __name__ == '__main__':
    INPUT_FOLDER = 'C:/Users/zhaoyh/Desktop/segmentation/data/'
    ...
    for n in range(len(segmented_lungs_fill)):
        plt.imshow(segmented_lungs_fill[n], cmap=plt.cm.gray)
        plt.show()
